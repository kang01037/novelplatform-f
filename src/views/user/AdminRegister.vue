      ...
      <div class="form-area">
        <div class="form-container">
          <div class="form-header">
            ...
            <p class="form-subtitle">创建管理员账户，管理平台运营</p>
          </div>
            ...
            <div class="form-row">
              <div class="input-group">
                ...
                <div class="input-wrapper">
                  ...
                  <input type="password" v-model="form.adminKey" placeholder="请输入管理员注册密钥" required>
                </div>
              </div>
              <div class="input-group">
                <label>性别</label>
          ...
          <div class="form-footer">
            ...
            <router-link to="/register" class="back-link">普通用户注册</router-link>
          </div>
        </div>
      </div>
    </div>
...
const handleRegister = async () => {
  ...
  if (form.value.adminKey !== ADMIN_SECRET_KEY) {
    alert('管理密钥错误，无法注册管理员账户')
    return
  }
  loading.value = true
  try {
